package personal.xml.jaxp.trax.chain;
...
public class ChainTestRun {
    public static void main(String[] args) throws IOException, TransformerConfigurationException, SAXException {
        ...
        StreamSource xsl1 = new StreamSource(new ClassPathResource("personal/xml/jaxp/trax/chain/votes.xsl").getInputStream());
        StreamSource xsl2 = new StreamSource(new ClassPathResource("personal/xml/jaxp/trax/chain/votesOnly.xsl").getInputStream());
        ...
        reader.parse(new InputSource(new ClassPathResource("personal/xml/jaxp/trax/chain/vote.xml").getInputStream()));
    }
}
